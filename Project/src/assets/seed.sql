CREATE TABLE IF NOT EXISTS profile(id INTEGER PRIMARY KEY AUTOINCREMENT ,name TEXT NOT NULL,surname TEXT,age INTEGER,height FLOAT,weight FLOAT);
...
CREATE TABLE IF NOT EXISTS appointment(id INTEGER PRIMARY KEY AUTOINCREMENT,title TEXT NOT NULL,description TEXT,place TEXT, timeapp datetime NOT NULL , profileId INTEGER NOT NULL );
